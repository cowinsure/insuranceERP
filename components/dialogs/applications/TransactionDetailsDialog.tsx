        ...
        <>
          <div className="flex   justify-between gap-2 py-4">
            ...
            <div className="flex  items-center gap-2">
              ...
              <Badge
                variant={"default"}
                className={`text-xs ${getStatusBadge(applicationStatus)}`}
              >
                {applicationStatus}
              </Badge>
            </div>
          ...
          <div className="flex items-center gap-2 pb-4">
            <h2 className="text-lg font-medium text-gray-600">
              {" "}
              View complete transaction information and receipt
            </h2>
          </div>
              ...
              <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm font-semibold text-gray-900">
                    {paymentData[0]?.insurance_number}
                  </p>
                </div>
              </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm font-semibold text-gray-900">
                    {paymentData[0]?.trx_date
                      ? new Date(paymentData[0].trx_date).toLocaleDateString(
                          "en-IN",
                          {
                            year: "numeric",
                            month: "long",
