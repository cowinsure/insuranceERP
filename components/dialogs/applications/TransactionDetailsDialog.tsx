...
import { Calendar, CreditCard, Hash, Building2, FileText, User, Receipt, Eye, Download, DollarSign, CheckCircle, XCircle } from "lucide-react"
...
export default function TransactionDetailsDialog({ isOpen , onClose }: PaymentDialogProps) {
  const [selectedStatus, setSelectedStatus] = useState<string>("")
  const { get, post, loading, error } = useApi();
  const [insuranceStatus, setInsuranceStatus] = useState<any>();
        ...
        <div className="space-y-6 max-h-[500px] overflow-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg bg-gray-50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-semibold text-gray-900 truncate">{transactionData.transactionId}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg bg-gray-50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-semibold text-green-600">{transactionData.amount}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg bg-gray-50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Badge className={`text-xs ${getTypeColor(transactionData.type)}`}>{transactionData.type}</Badge>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg bg-gray-50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-semibold text-gray-900">{transactionData.through}</p>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 border border-gray-200 rounded-lg bg-gray-50">
              <p className="text-sm text-gray-700">{transactionData.remarks}</p>
            </div>
          </div>
