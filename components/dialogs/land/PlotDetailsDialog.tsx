              ...
              {isLoaded ? (
                <div className="space-y-2">
                  ...
                  >
                    ...
                    {plot.plotCoordinates &&
                      plot.plotCoordinates.length > 2 && (
                        <Polygon
                          path={sortPolygonCoords(plot.plotCoordinates).map(
                            (coord) => ({
                    ...
                    {plot.innerCoordinates &&
                      plot.innerCoordinates.length > 2 && (
                        <Polygon
                          path={sortPolygonCoords(plot.innerCoordinates).map(
                            (coord) => ({
                              lat: parseFloat(coord.latitude),
                              lng: parseFloat(coord.longitude),
                            })
                    ...
                    {plot.landCoordinates &&
                      plot.landCoordinates.length > 2 && (
                        <Polygon
                          path={sortPolygonCoords(plot.landCoordinates).map(
                            (coord) => ({
                              lat: parseFloat(coord.latitude),
                              lng: parseFloat(coord.longitude),
                            })
                    ...
                    {plot.swMark && (
                      <Marker
                        key={`sw_mark`}
                        position={{
                          lat: parseFloat(plot.swMark.latitude),
                          lng: parseFloat(plot.swMark.longitude),
                        }}
                    ...
                    {plot.nCorner && (
                      <Marker
                        key={`n_corner`}
                        position={{
                          lat: parseFloat(plot.nCorner.latitude),
                          lng: parseFloat(plot.nCorner.longitude),
                        }}
                    ...
                    {plot.eCorner && (
                      <Marker
                        key={`e_corner`}
                        position={{
                          lat: parseFloat(plot.eCorner.latitude),
                          lng: parseFloat(plot.eCorner.longitude),
                        }}
                    ...
                    {plot.nMark && (
                      <Marker
                        key={`n_mark`}
                        position={{
                          lat: parseFloat(plot.nMark.latitude),
                          lng: parseFloat(plot.nMark.longitude),
                        }}
                    ...
                    {plot.eMark && (
                      <Marker
                        key={`e_mark`}
                        position={{
                          lat: parseFloat(plot.eMark.latitude),
                          lng: parseFloat(plot.eMark.longitude),
                        }}
                    ...
                    {plot.intersection && (
                      <Marker
                        key={`intersection`}
                        position={{
                          lat: parseFloat(plot.intersection.latitude),
                          lng: parseFloat(plot.intersection.longitude),
                        }}
