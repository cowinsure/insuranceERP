...
import { FaRegHeart, FaBuilding, FaDollarSign, FaUser } from "react-icons/fa";
  ...
  return (
          ...
          <div className="flex flex-col gap-8 items-center h-full">
            ...
            <div className="w-64 bg-gray-100 flex items-center justify-center rounded-lg overflow-hidden">
              {application.special_mark ? (
                <Image
                  src={application.special_mark as string}
                  alt={"Image"}
                  width={256}
                  height={256}
    ...
    <div className="grid sm:grid-cols-2 gap-8 mt-8">
      ...
      />
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-xs">
            <ModalHeader
              icon={<MdOutlineCalendarToday className="text-yellow-600" />}
              header="Timestamps"
            />
            <div className="grid sm:grid-cols-2 gap-8 mt-8">
              {/* <DetailsSection
      ...
      /> */}
              <DetailsSection
                ...
                value={application.last_vaccination_date}
                icon={<MdOutlineCalendarToday />}
                className="text-yellow-700 bg-yellow-200"
              />
              <DetailsSection
                label="Last Deworming"
                value={application.last_deworming_date}
                icon={<MdOutlineCalendarToday />}
                className="text-yellow-700 bg-yellow-200"
              />
              <DetailsSection
                label="Insurance Start Date"
                value={application.insurance_start_date}
                icon={<MdOutlineCalendarToday />}
                className="text-yellow-700 bg-yellow-200"
              />
              <DetailsSection
                label="Insurance End Date"
                value={application.insurance_end_date}
                icon={<MdOutlineCalendarToday />}
                className="text-yellow-700 bg-yellow-200"
              />
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-xs">
            ...
            <div className="grid sm:grid-cols-2 gap-8 mt-8">
              ...
              <DetailsSection
                ...
                value={application.insurance_status}
                icon={<RxIdCard />}
                className="text-purple-700 bg-purple-200"
              />
              <DetailsSection
      ...
      /> */}
              ...
              <DetailsSection
                label="Policy Terms"
                value={application.policy_terms || "N/A"}
                icon={<HiOutlineDocumentText />}
                className="text-purple-700 bg-purple-200"
              />
              {/* <DetailsSection
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-xs">
            ...
            <div className="grid sm:grid-cols-2 gap-8 mt-8">
              ...
              <DetailsSection
                ...
                value={application.premium_amount}
                icon={<FaDollarSign />}
                className="text-green-700 bg-green-200"
              />
              <DetailsSection
